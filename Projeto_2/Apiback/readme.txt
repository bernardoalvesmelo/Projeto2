Configurar db_config de acordo com especificações locais, 
não precisa alterar nome da database.

É necessário que scripts estejam abilitados nas configurações do dispositivo
para rodar o programa, além de ser necessário importar as bibliotecas respectivas,
para importar flask, pode usar o comando: python -m pip install flask
